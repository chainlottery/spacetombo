...
import { Lottery, PriceConsumer } from '../typechain';
import { LotteryState, Parameters, Periods, Ship } from "../types/Lottery"
import { getDefaultParameters, lotteryFixture, getSignersIdentity, SignerIdentity } from './utils';
import { BigNumber } from '@ethersproject/bignumber';
import { network, deployments, ethers } from "hardhat";
chai.use(require('chai-bn')(BigNumber));

describe('Lottery Unit Tests', async function () {
    const dummyShip: Ship = {parts: {body: BigNumber.from(0), skin: BigNumber.from(0), weapon: BigNumber.from(0), booster: BigNumber.from(0)}};
    ...
    it('State check/Players 1,2,3 participate', async () => {
        // Generate a new lottery
